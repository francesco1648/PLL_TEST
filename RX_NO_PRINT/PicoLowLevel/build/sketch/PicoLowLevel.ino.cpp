#line 1 "C:\\Users\\Titania\\Desktop\\isaac\\test\\test_pll_speed\\RX_NO_PRINT\\PicoLowLevel\\PicoLowLevel.ino"
...
#line 52 "C:\\Users\\Titania\\Desktop\\isaac\\test\\test_pll_speed\\RX_NO_PRINT\\PicoLowLevel\\PicoLowLevel.ino"
void okInterrupt();
#line 57 "C:\\Users\\Titania\\Desktop\\isaac\\test\\test_pll_speed\\RX_NO_PRINT\\PicoLowLevel\\PicoLowLevel.ino"
void navInterrupt();
#line 62 "C:\\Users\\Titania\\Desktop\\isaac\\test\\test_pll_speed\\RX_NO_PRINT\\PicoLowLevel\\PicoLowLevel.ino"
void sendFeedback();
#line 121 "C:\\Users\\Titania\\Desktop\\isaac\\test\\test_pll_speed\\RX_NO_PRINT\\PicoLowLevel\\PicoLowLevel.ino"
void setup();
#line 193 "C:\\Users\\Titania\\Desktop\\isaac\\test\\test_pll_speed\\RX_NO_PRINT\\PicoLowLevel\\PicoLowLevel.ino"
void loop();
#line 52 "C:\\Users\\Titania\\Desktop\\isaac\\test\\test_pll_speed\\RX_NO_PRINT\\PicoLowLevel\\PicoLowLevel.ino"
void okInterrupt()
{
...
void sendFeedback()
{
  ...
  Debug.println("ciao12", Levels::INFO);
  mcp2515.sendMessage(&canMsg);
  Debug.println("ciao13", Levels::INFO);
  ...
  mcp2515.sendMessage(&canMsg);
#endif*/
Debug.println("ciao14", Levels::INFO);
}
...
void loop()
{
  if (Serial.available() > 0)
  {
    ...
    Debug.println("ciao", Levels::INFO);
    ...
    Debug.println("ciao1", Levels::INFO);
    // send telemetry
    ...
    Debug.println("ciao2", Levels::INFO);
    if (mcp2515.readMessage(&canMsg) == MCP2515::ERROR_OK)
    {
      ...
      Debug.println("ciao3", Levels::INFO);
      switch (type)
      {
      case MOTOR_SETPOINT:
    ...
    { // if we do not receive data for more than a second stop motors
      ...
      motorTrLeft.stop();
      motorTrRight.stop();
      Debug.println("ciao4", Levels::INFO);
    }

    // display.handleGUI();
    Debug.println("ciao5", Levels::INFO);
    display.showLogo();

    Debug.println("showLogo", Levels::INFO);
    float tim = millis() - time_cur;
    Debug.print("tim : ", Levels::INFO);
    Debug.println(tim, Levels::INFO);
    delay(1000);
    display.showBattery();
    delay(1000);
  }
