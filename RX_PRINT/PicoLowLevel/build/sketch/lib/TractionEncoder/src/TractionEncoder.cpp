#line 1 "C:\\Users\\Titania\\Desktop\\isaac\\test\\test_pll_speed\\RX_PRINT\\PicoLowLevel\\lib\\TractionEncoder\\src\\TractionEncoder.cpp"
...
int TractionEncoder::getSpeed() {
    ...
    long rpm = delta * ENC_TR_CONVERSION / deltat;


    if(filter != NULL) rpm = filter->filter(rpm);

    return (int)(invert?-rpm:rpm);
}
