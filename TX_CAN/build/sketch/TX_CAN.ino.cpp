#line 1 "C:\\Users\\Titania\\Desktop\\isaac\\test\\test_pll_speed\\TX_CAN\\TX_CAN.ino"
...
#line 52 "C:\\Users\\Titania\\Desktop\\isaac\\test\\test_pll_speed\\TX_CAN\\TX_CAN.ino"
void okInterrupt();
#line 57 "C:\\Users\\Titania\\Desktop\\isaac\\test\\test_pll_speed\\TX_CAN\\TX_CAN.ino"
void navInterrupt();
#line 62 "C:\\Users\\Titania\\Desktop\\isaac\\test\\test_pll_speed\\TX_CAN\\TX_CAN.ino"
void sendFeedback();
#line 121 "C:\\Users\\Titania\\Desktop\\isaac\\test\\test_pll_speed\\TX_CAN\\TX_CAN.ino"
void setup();
#line 193 "C:\\Users\\Titania\\Desktop\\isaac\\test\\test_pll_speed\\TX_CAN\\TX_CAN.ino"
void loop();
#line 52 "C:\\Users\\Titania\\Desktop\\isaac\\test\\test_pll_speed\\TX_CAN\\TX_CAN.ino"
void okInterrupt()
{
...
void loop()
{
  if (Serial.available() > 0)
  {
    ...
    canMsg.can_dlc = 8;
    canMsg.can_id |= MOTOR_FEEDBACK << 16;
    canMsg.data[0] = ((uint8_t *)&input)[0];
    canMsg.data[1] = ((uint8_t *)&input)[1];
    canMsg.data[2] = ((uint8_t *)&input)[2];
    canMsg.data[3] = ((uint8_t *)&input)[3];
    canMsg.data[4] = ((uint8_t *)&input)[0];
    canMsg.data[5] = ((uint8_t *)&input)[1];
    canMsg.data[6] = ((uint8_t *)&input)[2];
    canMsg.data[7] = ((uint8_t *)&input)[3];
